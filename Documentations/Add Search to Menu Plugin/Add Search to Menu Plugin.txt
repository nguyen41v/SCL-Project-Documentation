...
On the side menu, hover over on the *Plugins* button (MemphisSS01.png). Then click *Add New* (MemphisSS02.png). Search for the plugin in the search bar to the top right (MemphisSS03.png). Then click *Install Now* for the plugin (MemphisSS04.png). Once you are done installing go back to WordPress and click on the *Plugins* button (MemphisSS01.png). Then scroll down until you see "Memphis Documents Library" and click the *Activate* button underneath it (MemphisSS05.png).

### Adding and moving folders
Once you have the Memphis Documents Library plugin activated, there should be a button for it on the side called *Memphis Docs* (MemphisSS06.png). Click on it and then click on *Options* (MemphisSS07.png). Then click *Edit Folders* (MemphisSS08.png). There are several options here. You can add a main folder with the *Add Main Folder* button which will appear at the top of the plugin (MemphisSS09.png). You can also add subfolders of other folders with the *Add Folder* button (MemphisSS10.png). Once you add a folder, you can name it and you can also change the order number (MemphisSS9.png). Changing the order number will change the folder's location relative to other folders in the same level as it. Once you are done editing your folders, click *Save Folders* (MemphisSS11.png).
